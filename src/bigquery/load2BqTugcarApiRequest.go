...
// Inerface
type LoadBqTugcarApiRequest struct{}

///////////////////////////////////////////////////
/* ===========================================
//取得したGCS BuketデータをBigQueryへロードする
* =========================================== */
func (l LoadBqTugcarApiRequest) Load2BqTugcarApiRequest(_pRecord interface{}) (int, error) {
	...
	//BqにBulk Insertを行う
	rc, err := load2BqTugcarApiRequest(_pRecord, bqClient, &bqCtx)
	if err != nil {
		return 0, err
	}
...
=========================================== */
func load2BqTugcarApiRequest(_records interface{}, bqClient *bigquery.Client, bqCtx *context.Context) (int, error) {

	//引数interfaceをCast
	records := _records.([]TABLE.TugcarApiRequestImport)
	...
	//チャンクを計算
	var rss [][]TABLE.TugcarApiRequestImport
